...
const Blogtags = () => {
    ...
    const blogData = async () => {
        ...
        let url = endPoint + 'blog/tags/'+params.tag;
        var cpage = 1;
        if(page){
            cpage = page
            url = url+'?page='+page;
        ...
        try {
            ...
            // console.log('tags ', blogs, blogTags)
        ...
        <>
            ...
            <div className='py-10'>
                {blogs.map((blog) => {
                    return (
                        <>
                            <div className='space-y-5 flex flex-col w-full lg:w-7/12 mx-auto px-3 '>
                                ...
                                <div className='space-y-3 flex flex-col'>
                                    ...
                                    <p dangerouslySetInnerHTML={{ __html: `Posted in &nbsp;${blog.tags}` }}></p>
